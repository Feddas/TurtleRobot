...
///// <summary>
///// https://github.com/tenpn/unity3d-ui/blob/master/UnityEngine.UI/UI/Core/SetPropertyUtility.cs
///// </summary>
...
//    {
//        Debug.Log("old:" + currentValue.ToString() + " new value " + newValue.ToString());
...
///// <summary>
///// Allows an image to be rotated in increments of 90 degrees
///// Image is a textured element in the UI hierarchy.
///// This class is copied from https://bitbucket.org/snippets/MatkovIvan/9oRL which was referenced at http://feedback.unity3d.com/suggestions/4-dot-6-ui-image-flip-horizontal-slash-vertical-and-rotate-90-180-270-modifiers
///// </summary>
...
//        set
//        {
//            Debug.Log("prop old:" + m_Rotate.ToString() + " new value " + value.ToString()); if (SetPropertyUtility.SetStruct(ref m_Rotate, value)) SetVerticesDirty();
//        }
//    }
...
//    {
//        Debug.Log("OnPopulateMesh stared");
...
//        {
//            foreach (var vert in vbo)
//            {
//                vh.AddVert(vert);
//            }
//            vh.FillMesh(toFill);
//        }
//        Debug.Log("OnPopulateMesh ended");
//    }
